        ...
        @{
            ...
            Rules = @(
                ...
                @{
                    ...
                    Description = 'The normalized startup predicate takes the next-item branch, identified by the following node load'
                    Original = '7F'
                    Replacement = 'EB'
                    Variants = @(
                        @{
                            Pattern = '83 78/F8 ?? 02 7F ?? 48/F8 8B 80/C0 ?? ?? ?? ?? 8B 40/C0 ?? 80 B8/F8 ?? ?? ?? ?? 00 75 ?? 8B 40/C0 ?? 83 F8/F8 01 0F 85 ?? ?? ?? ?? 83 F8/F8 05 74 ?? 83 F8/F8 0A 0F 85 ?? ?? ?? ?? 48/F8 8B 40/C0'
                            PatchOffset = 4
                        }
                        @{
                            Pattern = '83 78/F8 ?? 02 7F ?? 48/F8 8B 80/C0 ?? ?? ?? ?? 8B 40/C0 ?? 80 B8/F8 ?? ?? ?? ?? 00 75 ?? 8B 80/C0 ?? ?? ?? ?? 83 F8/F8 01 0F 85 ?? ?? ?? ?? 83 F8/F8 05 74 ?? 83 F8/F8 0A 0F 85 ?? ?? ?? ?? 48/F8 8B 40/C0'
                            PatchOffset = 4
                        }
                    )
                }
                ...
                @{
                    ...
                    Variants = @(
                        ...
                        @{
                            # UserMayLoad is the fall-through path; the MV2 error is out of line.
                            Pattern = '83 78/F8 ?? 02 7F ?? 48/F8 8B 80/C0 ?? ?? ?? ?? 8B 40/C0 ?? 80 B8/F8 ?? ?? ?? ?? 00 75 ?? 8B 80/C0 ?? ?? ?? ?? 83 F8/F8 01 0F 85 ?? ?? ?? ?? 83 F8/F8 05 74 ?? 83 F8/F8 0A 0F 85 ?? ?? ?? ?? 48/F8 8D 84/C7 24 ?? ?? ?? ?? 48/F8 89 C0/C0 48/F8 89 C0/C0 48/F8 89 C0/C0 E8 ?? ?? ?? ?? 48/F8 8D 44/C7 24 ?? 88 40/C0 F8'
                            PatchOffset = 4
                            RequiredPatternOffset = 255
                            RequiredPattern = '48/F8 8D 84/C7 24 ?? ?? ?? ?? 48/F8 89 C0/C0 BA ?? ?? 00 00 E8 ?? ?? ?? ?? 48/F8 8D 44/C7 24 ?? C6 40/C0 F8 00'
                        }
                    )
                }
                @{
